...
var stabThreshold=3.75;	//stability threshold in mg/mL In this case arbitrarily set
...
var delBoxSingle= "0.1 mL/hour = 0.05 micrograms/kg/minute \n0.5 mL/hour = 0.25 micrograms/kg/minute \n1 mL/hour = 0.5 micrograms/kg/minute ";//the delivery results when single strength infusion selected
var delBoxDouble= "0.1 mL/hour = 0.1 microgram/kg/minute \n0.5 mL/hour = 0.5 micrograms/kg/minute ";
...
var intermedStabMessage="\nThis is greater than the 48-hour stability threshold of "+intermedStabThreshold+" "+ampAmtUnits+"/mL.\nThe infusion has a 24-hour stability. "
...
var warningBox="Doses of 0.15 - 0.5 micrograms/kg/min represent sedation dose range.\nSee 'Midazolam for Seizures' calculator if anticonvulsant dosing required";
